...
$.ajax({
  ...
  success: function success(data) {
    ...
    $.each(exchange_rates, function (key, value) {
      var rateToUsd = value.value / unitBtcToUsd; // Select USD by default
...
$currencySelect.change(function () {
  ...
  var currencySymbol = $(this).find(":selected").data('currency-symbol'); // Switch price
...
__webpack_require__(/*! C:\laragon\www\coingecko\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\coingecko\resources\sass\app.scss */"./resources/sass/app.scss");
